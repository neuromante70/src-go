...
/*
Reserved keywords
any	default	func	interface	select, break	defer	go	map	struct
case	else	goto	package	switch, chan	fallthrouogh	if	range	type
const	for	import	return	var, continue
