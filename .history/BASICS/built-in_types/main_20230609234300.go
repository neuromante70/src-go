...
any, default, func, interface, select, break, defer, go, map, struct, case, else, goto, package, switch, chan, fallthrouogh, if, range, type, const, for, import, return, var, continue
...
func main() {
	...
	*/
	...
	fmt.Println(rUni) // print 97, corresponding Utf8 code point for vowel a
	rOct := '\x61'
	fmt.Println(rOct)
	rOct8 := '\141'
	fmt.Println(rOct8)
