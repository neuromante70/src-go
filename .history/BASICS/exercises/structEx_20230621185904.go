...
// 2. There should be a hashmap - that has key of type int which will be the user ID and the value will be the user object itself - make this userHM outside of main so all function can access it
var userHM = map[int]user{}

/*
3. There should be 4 functions:
3a. An add function that takes in as an argument a user object and adds it to the userHM -
...
/*
  3b. A get function that takes in a user id and returns the user from the userHM IF exists - if not return an error
*/
...
// 3c. A delete function that takes in a user id and deletes that user from the userHM
