...
// 2. There should be a userHM - that has key of type int which will be the user ID and the value will be the user object itself - make this userHM outside of main so all function can access it
