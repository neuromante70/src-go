...
func main() {
	...
	prt("5 - 9 =", calc.Add(5, 3).Sub(5, 9))      // -4
	prt("22 * 33 =", calc.Add(5, 3).Mult(22, 33)) // 726
	prt("4 / 0 =", calc.Add(5, 3).Divide(4, 0))   // impossible to divide by zero
	prt("12 / 6 =", calc.Add(5, 3).Divide(12, 6)) // 2
	prt()
	_ = calc.Add(5, 3).EncodeHistory()
	calc.SaveToFile(calculator.Calculator.EncodeHistory(), "test.json")
