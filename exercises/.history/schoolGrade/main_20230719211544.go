...
func main() {
	...
	prt("calculating Carl grades average for math (2)", v)     // Carl math average = 2
	// grd, _ = s2.avgGrade()
	...
	v, _ = s2.avgGradeBySbj(2)
		prt("calculating Janis grades average for science (3):", v) // Janis grades average for science = 3
}
