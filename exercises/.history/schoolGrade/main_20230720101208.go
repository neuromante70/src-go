...
func main() {
	...
	ex4 := grades.Exam{Id: IdStd: 4, Subject: 1, 1, 1} // exNr 4, Carl, math, low failure
	ex5 := grades.Exam{Id: IdStd: 5, Subject: 1, 1, 3} // exNr 5, Carl, math, satisfactory
	ex6 := grades.Exam{Id: IdStd: 6, Subject: 1, 0, 3} // exNr 6, Carl, english, satisfactory
	ex2 := grades.Exam{Id: IdStd: 2, Subject: 2, 1, 3} // exNr 2, Janis, math, satisfactory
	ex7 := grades.Exam{Id: IdStd: 7, Subject: 2, 2, 4} // exNr 7, Janis, science, good
	ex8 := grades.Exam{Id: IdStd: 8, Subject: 2, 2, 2} // exNr 8, Janis, science, low pass but certifying
	ex3 := grades.Exam{Id: IdStd: 3, Subject: 3, 3, 6} // exNr 3, Luise, history, outstanding
	ex9 := grades.Exam{Id: IdStd: 9, Subject: 3, 0, 2} // exNr 3, Luise, english, low pass but certifying
