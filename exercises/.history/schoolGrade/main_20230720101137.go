...
func main() {
	...
	ex4 := grades.Exam{Id: 4, 1, 1, 1} // exNr 4, Carl, math, low failure
	ex5 := grades.Exam{Id: 5, 1, 1, 3} // exNr 5, Carl, math, satisfactory
	ex6 := grades.Exam{Id: 6, 1, 0, 3} // exNr 6, Carl, english, satisfactory
	ex2 := grades.Exam{Id: 2, 2, 1, 3} // exNr 2, Janis, math, satisfactory
