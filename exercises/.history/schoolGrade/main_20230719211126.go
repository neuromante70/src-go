...
func main() {
	...
	prt("calculating Carl grades average for math (2)") // Carl math average = 2
	...
	grd, _ = s2.avgGrade()
	prt("the average of student", Students[2], " is ", grd) // Janis grades average = 3
	prt("calculating Janis grades average for science (2)") // Janis grades average = 3
	prt(s2.avgGradeBySbj(2)) // Janis grades average for science = 3
	// prt(Exams)
}
