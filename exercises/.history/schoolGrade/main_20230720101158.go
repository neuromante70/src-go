...
func main() {
	...
	ex2 := grades.Exam{Id: IdStd: 2, 2, 1, 3} // exNr 2, Janis, math, satisfactory
	ex7 := grades.Exam{Id: IdStd: 7, 2, 2, 4} // exNr 7, Janis, science, good
	ex8 := grades.Exam{Id: IdStd: 8, 2, 2, 2} // exNr 8, Janis, science, low pass but certifying
	ex3 := grades.Exam{Id: IdStd: 3, 3, 3, 6} // exNr 3, Luise, history, outstanding
