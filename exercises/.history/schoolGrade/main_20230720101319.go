...
func main() {
	...
	ex4 := grades.Exam{Id: 4, IdStd: 1, Subject: 1, Grade: 1} // exNr 4, Carl, math, low failure
	ex5 := grades.Exam{Id: 5, IdStd: 1, Subject: 1, Grade: 3} // exNr 5, Carl, math, satisfactory
	ex6 := grades.Exam{Id: 6, IdStd: 1, Subject: 0, Grade: 3} // exNr 6, Carl, english, satisfactory
	ex2 := grades.Exam{Id: 2, IdStd: 2, Subject: 1, Grade: 3} // exNr 2, Janis, math, satisfactory
	ex7 := grades.Exam{Id: 7, IdStd: 2, Subject: 2, Grade: 4} // exNr 7, Janis, science, good
	ex8 := grades.Exam{Id: 8, IdStd: 2, Subject: 2, Grade: 2} // exNr 8, Janis, science, low pass but certifying
	ex3 := grades.Exam{Id: 3, IdStd: 3, Subject: 3, Grade: 6} // exNr 3, Luise, history, outstanding
	ex9 := grades.Exam{Id: 9, IdStd: 3, Subject: 0, Grade: 2} // exNr 3, Luise, english, low pass but certifying
